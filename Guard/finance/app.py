...
def buy():
    ...
    if request.method == "GET":
        ...
        if shares < 0:
            return apology("Share no Allowed")
...
def register():
    ...
    if request.method == "GET":
        ...
        if not confirmation:
            return apology("Please, give Confirmation")

        if password != confirmation:
            return apology("Please, write a match Passwords")
...
def sell():
    ...
    if request.method == "GET":
        ...
        if shares > user_shares_real:
            return apology("You do no have this amount of Shares")
